/**
 * Sync starter for HR Talent Map v2 work_format background spike.
 */
...
export const handler: Handler = async (
  ...
  try {
    ...
    const reportPayload = {
      ...
      title: "Work format background spike",
      summary: null,
      fit_score: null,
      content_json: {},
    ...
    const workerUrl = `${origin}/.netlify/functions/hr-talent-map-v2-work-format-worker-background`;
    ...
    console.error("[hr-talent-map-v2-work-format-start] unhandled", {
      message,
